...
const pricingData = [
  {
    ...
    getIn: [
      ...
      {
        rightIcon: true,
        description: "Limit listening songs per day",
      },
      {
        rightIcon: false,
        description: "ad-free",
...
const RightIcon = ({ fillColor }:{fillColor:string}) => {
  return (
    <svg
      width="32"
      height="32"
...
const Arrow = ({ strokColor }:{strokColor:string}) => {
  return (
    <svg
      width="107"
      height="88"
        ...
        {pricingData.map((data, index) => (
          <div
            ...
            <div className="flex flex-col text-left">
              ...
              <button
                className={"btn btn-white w-full text-lg border-[1px] rounded py-2.5"}
              >
                Get Started Now
              </button>
