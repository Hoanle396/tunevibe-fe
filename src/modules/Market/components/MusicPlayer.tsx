...
const MusicPlayer: FCC<Props> = ({ src }) => {
  ...
  return (
    <div className="absolute z-10 bottom-0 w-full flex justify-center items-center gap-4">
      ...
      <div
        onClick={onPrev}
        className="p-2 h-fit flex items-center rounded-full text-primary text-xl cursor-pointer  hover:bg-slate-300"
      >
        <TbRewindBackward10 />
      </div>
